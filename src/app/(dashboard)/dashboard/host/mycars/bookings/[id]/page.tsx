...
import HostBookingCard from '@/components/dashboard/host/hostbookingCard'
import HostBookingCardSkeleton from '@/components/skeleton/hostBookingCardSkeleton'
...
export default function page() {
    ...
    //  data
    const { data: response, isLoading, isPlaceholderData } = trpc.booking.getBookingsForMyCars.useQuery(
        { carId: id, page, limit },
    ...
    return (
        <Stack gap="8" w="full" position="relative">
            ...
            <Flex justify="space-between" align={{ base: "flex-start", md: "center" }} direction={{ base: "column", md: "row" }} gap="4">
                <Box>
                    <Heading size="3xl" fontWeight="900" letterSpacing="tight">Bookings for <b color='teal.600'>{myBookings[0]?.car?.name}</b></Heading>
